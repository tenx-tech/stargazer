...
| stargazerServerUrl | URL string                                | Yes      | The URL the local Stargazer upload server is running at, e.g. `http://1.2.3.4:9000/screenshot`. You must provide an IP address with this URL.                                                                |
